...
TownList["Dewford Town"] = new Town("Dewford Town", [107]);
TownList["Slateport City"] = new Town("Slateport City", [110]);
TownList["Mauville City"] = new Town("Mauville City", [117]);
TownList["Verdanturf Town"] = new Town("Verdanturf Town", [116]);
TownList["Lavaridge Town"] = new Town("Lavaridge Town", [112]);
TownList["Fallarbor Town"] = new Town("Fallarbor Town", [113]);
TownList["Fortree City"] = new Town("Fortree City", [119]);
TownList["Lilycove City"] = new Town("Lilycove City", [121]);
TownList["Mossdeep City"] = new Town("Mossdeep City", [125]);
TownList["Sootopolis City"] = new Town("Sootopolis City", [126]);
