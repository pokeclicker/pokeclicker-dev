...
class AchievementHandler {
    ...
    public static initialize() {
        ...
        AchievementHandler.addAchievement("I wonder how much is down there...", "Dig up 10000 items", new DigItemsRequirement(10000), 0.01);
        ...
        for (let i = 1; i <= GameConstants.AMOUNT_OF_ROUTES_KANTO; i++) {
            ...
            AchievementHandler.addAchievement("Route " + i + " explorer", "Get 1000 kills on route " + i, new RouteKillRequirement(1000, i), 0.05);
            AchievementHandler.addAchievement("Route " + i + " conqueror", "Get 10000 kills on route " + i, new RouteKillRequirement(10000, i), 0.10);
        }
        ...
        for (let i = 0; i < GameConstants.KantoDungeons.length; i++) {
            ...
            AchievementHandler.addAchievement(`${GameConstants.KantoDungeons[i]} hermit`, `Clear 1000 times`, new ClearDungeonRequirement(1000, i), 0.01);
        }
